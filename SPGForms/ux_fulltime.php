...
<html>
	...
	<body>
        <center>
            <img src="img/ux_logo.png"><br>
            <h3>APPLICANT PROFILE (FULLTIME)</h3></center>
        ...
        <form id="profileForm" name="bioForm" action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post">
            <input type="hidden" name="Department" value="UX">
            <input type="hidden" name="DeptFullTempType" value="Fulltime">
            
            <!-- SECTION 01 - General Bio information -->
            <?php include 'includes/personal_info_01.php'; ?>

            <!-- SECTION 02 - Educational Background information -->
            <?php include 'includes/education_02.php'; ?>

            <!-- SECTION 03 - References information -->
            <?php include 'includes/references_02.php'; ?>

            <!-- SECTION 04 - Recent Interviews, Ideal Companies & Skill Sets -->
            <?php include 'includes/recent_interviews_01.php'; ?>
            <?php include 'includes/ideal_companies_01.php'; ?>
            <?php include 'includes/skillsets_01.php'; ?>
        ...
        <?php include 'includes/acknowledgment_fulltime_01.php'; ?>
