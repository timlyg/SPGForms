<!--
This is the first section personal info part of the larger form for temp for the following departments:
- Creative & Marketing Temp

Personal_Info_2: With the additional option "Do you have a car?"
-->
...
<table>
    ...
    <tr>
        <td colspan="2">
            Preferred W2 <input type="radio" name="W2or1099" value="W2"> or 1099 <input type="radio" name="W2or1099" value="1099">
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td colspan="2">
            ...
            YES <input type="radio" name="Car" value="YES"><br>NO <input type="radio" name="Car" value="NO">
        </td>
    </tr>
</table>
<script>
    $(function() {       
        ...
        $("input.phone").blur(function(){
          ...
          //      $("#HomePhone").removeClass("valid").addClass("invalid");
            }
            else {
                $("#HomePhone").attr("required", false);
        //        $("#HomePhone").removeClass("valid").removeClass("invalid");
            }
        });
