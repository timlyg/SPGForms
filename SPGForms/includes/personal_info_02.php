...
- Legal Services Fulltime/Temp

added DOB, Min Hourly rate, travel, Metro, Bar, Language, Disciplinary action, software
-->
...
<table>
    ...
    <tr>
        <td>
            ...
            $ <input class="money" name="MinSalary" id="MinSalary" placeholder="numbers only (optional)"><span class="moneyerr" id="MinSalaryErr"></span>
        </td>
        <td>
            MINIMUM HOURLY RATE<br>
            $ <input class="money" name="MinHourlyRate" id="MinHourlyRate" placeholder="numbers only (optional)"><span class="moneyerr" id="MinHourlyRateErr"></span>
        </td>
    </tr>
    <tr>
        <td>
            Available to travel?<br>
            YES <input type="radio" name="Travel" value="YES"><br>NO <input type="radio" name="Travel" value="NO">
        </td>
        <td>
            Where can you work in the Metro Area? List areas:<br>
            <input name="MetroAreas">
        </td>
    </tr>
    <tr>
        <td>
            BAR ADMISSIONS: In good standing?<br>
            YES <input type="radio" name="BarStanding" value="YES"><br>NO <input type="radio" name="BarStanding" value="NO">
        </td>
        <td>
            FOREIGN LANGUAGE FLUENCY:<br>
            <input name="ForeignLanguages">
        </td>
    </tr>
    <tr>
        <td>
            Have you ever been the subject of a disciplinary action by the bar of any state?<br>
            YES <input type="radio" name="BarDiscipline" value="YES"><br>NO <input type="radio" name="BarDiscipline" value="NO"><br>
            If yes, <input name="BarDisciplineNote">
        </td>
        <td>
            Software Experience:<br>
            <input name="SoftwareExperience">
        </td>
    </tr>
</table>
<script>
    $(function() {       
        ...
        $("#MinSalary").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && ((e.which < 48 && e.which != 46) || e.which > 57)) {
            //display error message
            $("#MinSalaryErr").html("Numbers Only").show().fadeOut("slow");
                return false;
            }
        });

        $("#MinHourlyRate").keypress(function (e) {
            //if the letter is not digit then display error and don't type anything
            if (e.which != 8 && e.which != 0 && ((e.which < 48 && e.which != 46) || e.which > 57)) {
            //display error message
            $("#MinHourlyRateErr").html("Numbers Only").show().fadeOut("slow");
                return false;
            }
        });
